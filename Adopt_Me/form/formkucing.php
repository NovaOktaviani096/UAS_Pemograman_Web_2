...
<div class="forms">
    <form action="" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
                <input type="text" name="id_kategori" <?php echo (isset($_GET['id_kucing'])) ?  "value = " . $result[0]["id_kategori"] . "" : "value = '' "; ?> required> <br>
                </td>
            </tr>
            <tr>
                <td>
    ...
    if (isset($_POST['submit'])) {
        tambahdatakucing( $_POST['id_kategori'],$_POST['foto'], $_POST['nama_kucing'], $_POST['umur'], $_POST['alamat'], $_POST['keterangan']);
    }
    if (isset($_POST['update'])) {
        updatekucing($_POST['id_kucing'], $_POST['id_kategori'] ,$_POST['foto'], $_POST['nama_kucing'], $_POST['umur'], $_POST['alamat'], $_POST['keterangan']);
    }
    ?>
</body>
